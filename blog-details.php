...
<body>
    ...
    <?php
        ...
        $sql = "SELECT * FROM blog_posts WHERE post_id ='$blogid' ";
            ...
            <div class="row">
                <div class="col-xxl-8 col-lg-7">
                    <div class="ot-blog blog-single">
                        <div class="blog-img"><img src="<?php echo $blog_image ?>" alt="Blog Image"></div>
                        <div class="blog-content">
                            <div class="blog-meta"><a href="blog-details.html"><i class="fa-solid fa-user"></i><?php echo $post_by ?></a> <a href="blog.html"><i class="fa-solid fa-calendar-days"></i><?php echo $post_date ?></a> <a href="blog.html"><i class="fa-solid fa-tag"></i><?php echo $tag ?></a></div>
                            <h2 class="blog-title"><?php echo $headline ?></h2>
                            <blockquote>
                                <p>“<?php echo $shot_desc ?>”</p><cite><?php echo $post_type ?></cite>
                            </blockquote>
                            <p class="mb-0">
                                <?php echo $desc ?>
                            </p>
                        ...
                        <div class="share-links clearfix">
                            <div class="row justify-content-between">
                                <div class="col-md-auto"><span class="share-links-title">Tags:</span>
                                    <div class="tagcloud"><a href="blog.html"><?php echo $tag ?></a> </div>
                                </div>
                    ...
                    <!--        <div class="col-12 form-group mb-0"><button class="ot-btn">Post Comment</button></div>-->
                    <!--    </div>-->
                    <!--</div>-->
                </div>
