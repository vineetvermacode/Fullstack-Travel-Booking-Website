...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Add Internal Exchange</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
...
<section class="section">
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Add Internal Exchange</h5>

        <form action="db/ie_resort.php" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="">
                        <select name="location_name" class="form-control">
                            ...
                            $sql = "SELECT location_name FROM internal_exchange_location";
