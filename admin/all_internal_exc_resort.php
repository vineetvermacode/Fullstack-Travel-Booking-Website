...
<div class="pagetitle">
  <h1>Internal Exchange</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="index.php">Home</a></li>
      <li class="breadcrumb-item">Internal Exchange</li>
      <li class="breadcrumb-item active">All Internal Exchange</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
    ...
    <div class="col-lg-12">
        ...
        <div class="card-body">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <?php
                    $sql = "SELECT * FROM internal_exc_resort";
                    $result = $conn->query($sql);
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>";
                            echo "<th scope='row'>" . $row["ie_resort_id"] . "</th>";
                            echo "<td>" . $row["location_name"] . "</td>";
                            echo "<td>" . $row["type"] . "</td>";
                            echo "<td>" . $row["resort_name"] . "</td>";
                            echo "<td><button type='button' class='btn btn-primary' data-bs-toggle='modal' data-bs-target='#overviewModal-" . $row["ie_resort_id"] . "'>View Overview</button></td>";
                            echo "<div class='modal fade' id='overviewModal-" . $row["ie_resort_id"] . "' tabindex='-1' role='dialog' aria-labelledby='overviewModalLabel' aria-hidden='true'>";
