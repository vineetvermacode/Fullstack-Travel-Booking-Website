...
<body>
    <?php
        $id = $_GET['resort'];
        $sql = "SELECT `ie_resort_id`, `location_name`, `type`, `resort_name`, `overview`, `free_wifi`, `reservation`, `credit_card`, `air_conditioner`, `car_parking`, `swimming_pool`, `image_url` FROM `internal_exc_resort` WHERE ie_resort_id ='$id'";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                $data['ie_resort_id'] = $row['ie_resort_id'];
                    ...
                    <aside class="sidebar-area">
                        ...
                        <div class="widget">
                            ...
                            <div class="recent-post-wrap">
                                ...
                                <?php
                                    $id = $_GET['resort'];
                                    $sql = "SELECT * FROM `internal_exc_resort` ORDER BY ie_resort_id DESC LIMIT 5";
                                    $result = $conn->query($sql);
