<?php include 'include/head.php'; ?>
    ...
    <?php
        $id = $_GET['location'];
        $sql = "SELECT * FROM associated_resort_location WHERE location_id='$id'";
    ...
    <section class="space-top space-extra-bottom">
        <div class="container">
            ...
            <div class="row">
            <?php
                $sql = "SELECT * FROM associate_resort WHERE  location_name='$id'";
                $result = $conn->query($sql);
                        ...
                        <div class="trip-box">
                            ...
                            <div class="trip-box__content">
                                <h2 class="trip-box__title box-title"><i class="fas fa-location-dot"></i> <a
                                        href="destination-details.php?resort=<?php echo $row['resort_id']; ?>"><?php echo $row['resort_name']; ?></a></h2><span class="trip-box__count"><?php echo $location_name; ?></span>
                            </div>
                        </div>
                    </div>
                    <?php
